  ...
  return (
    <div className="mx-auto max-w-4xl space-y-6">
      <div>
        ...
        <p className="mt-2 text-sm text-slate-400">Review your account details and preferences.</p>
      </div>
      <Card>
      ...
      <Card>
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <label className="block space-y-2 md:col-span-2">
            ...
            <textarea value={form.bio} readOnly rows={4} className="w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-slate-100 outline-none" />
          </label>
        </div>
        <div className="mt-5 flex flex-wrap gap-3">
          <Button variant="secondary"><UserRound className="h-4 w-4" /> Edit profile</Button>
          <Button variant="secondary"><Mail className="h-4 w-4" /> Change email</Button>
          <Button variant="secondary"><ShieldCheck className="h-4 w-4" /> Security settings</Button>
        </div>
      </Card>
    </div>
  );
